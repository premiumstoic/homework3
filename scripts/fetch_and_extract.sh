#!/bin/bash
# Script to fetch and extract quantum dot information from vinas toolbox
...
echo "  Saved: homework3/QDNP001.html"

# Fetch QDNP034
echo "Downloading QDNP034 from vinas toolbox..."
curl -s "$URL2" -o "homework3/QDNP034.html"
echo "  Saved: homework3/QDNP034.html"

echo ""
echo "=== Extracting Data ==="

# Extract QDNP001 data
echo ""
echo "QDNP001 Information:"
grep "var dsData" homework3/QDNP001.html | sed 's/^[[:space:]]*//' | sed 's/};.*//'

# Extract QDNP034 data
echo ""
echo "QDNP034 Information:"
grep "var dsData" homework3/QDNP034.html | sed 's/^[[:space:]]*//' | sed 's/};.*//'
